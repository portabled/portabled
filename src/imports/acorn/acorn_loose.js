...
//   is not enforced.
//
// - Bogus Identifier nodes with a name of `"ÃƒÆ’Ã‚Â¢Ãƒâ€¦Ã¢â‚¬Å“ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Å“"` are inserted whenever
...
(function(root, mod) {
  ...
  function readToken() {
    for (;;) {
      try {
        ...
        resetTo(pos);
        if (replace === true) replace = {start: pos, end: pos, type: tt.name, value: "ÃƒÆ’Ã‚Â¢Ãƒâ€¦Ã¢â‚¬Å“ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Å“"};
        if (replace) {
          if (options.locations) {
  ...
  function dummyIdent() {
    ...
    dummy.name = "ÃƒÆ’Ã‚Â¢Ãƒâ€¦Ã¢â‚¬Å“ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Å“";
    dummy.loc = getDummyLoc();
    return dummy;
  }
  function isDummy(node) { return node.name == "ÃƒÆ’Ã‚Â¢Ãƒâ€¦Ã¢â‚¬Å“ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Å“"; }
