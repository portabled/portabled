...
svgEditor.readLang({
	...
	ui: {
		...
		"palette_info": "Ikklikkja biex timla l-bidla fil-kulur, ikklikkja-bidla gÄ§all-bidla color stroke",
	...
	properties: {
		...
		"opacity": "Bidla magÄ§Å¼ula opaÄ‹itÃ  partita",
		"circle_cx": "CX Ä‹irku Tibdil jikkoordinaw",
		"circle_cy": "ÄŠirku Tibdil cy jikkoordinaw",
		"circle_r": "RaÄ¡Ä¡ ta &#39;Ä‹irku tal-Bidla",
		"ellipse_cx": "Bidla ellissi&#39;s CX jikkoordinaw",
		"ellipse_cy": "Ellissi Tibdil cy jikkoordinaw",
		"ellipse_rx": "RaÄ¡Ä¡ x ellissi Tibdil",
		"ellipse_ry": "RaÄ¡Ä¡ y ellissi Tibdil",
		"line_x1": "Bidla fil-linja tal-bidu tikkoordina x",
		"line_x2": "Linja tal-Bidla li jispiÄ‹Ä‹a x jikkoordinaw",
		"line_y1": "Bidla fil-linja tal-bidu y jikkoordinaw",
		"line_y2": "Linja Tibdil jispiÄ‹Ä‹a y jikkoordinaw",
		"rect_height": "GÄ§oli rettangolu Bidla",
		"rect_width": "Wisa &#39;rettangolu Bidla",
		"corner_radius": "Bidla Rectangle Corner Radius",
		"image_width": "Wisa image Bidla",
		"image_height": "GÄ§oli image Bidla",
		"image_url": "Bidla URL",
	...
	tools: { 
		"main_menu": "Main Menu",
		"bkgnd_color_opac": "Bidla fil-kulur fl-isfond / opaÄ‹itÃ ",
		"connector_no_arrow": "No arrow",
		"fitToContent": "Fit gÄ§all-kontenut",
		"fit_to_all": "Tajbin gÄ§all-kontenut",
		"fit_to_canvas": "Xieraq li kanvas",
		"fit_to_layer_content": "Fit-kontenut ta &#39;saff gÄ§al",
		"fit_to_sel": "Fit-gÄ§aÅ¼la",
		"align_relative_to": "Jallinjaw relattiv gÄ§all - ...",
		"relativeTo": "relattiv gÄ§all -:",
		"paÄ¡na": "paÄ¡na",
		"largest_object": "akbar oÄ¡Ä¡ett",
		"selected_objects": "oÄ¡Ä¡etti elett",
		"smallest_object": "iÅ¼gÄ§ar oÄ¡Ä¡ett",
		"new_doc": "Image New",
		"open_doc": "Open SVG",
		"export_img": "Export",
		"save_doc": "Image Save",
