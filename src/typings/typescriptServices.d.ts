...
declare module TypeScript.SimpleText {
    function fromSubstr(value: string, from: number, length: number): ISimpleText;
...
declare module TypeScript {
    class Scanner implements ISlidingWindowSource {
        ...
        static scanTrivia(parent: ISyntaxToken, tokenText: string, tokenFullStart: number, firstTriviaStartInToken: number, triviaLength: number, isTrailing: boolean): ISyntaxTriviaList;
        private scanTrivia(parent, tokenText, tokenFullStart, triviaStartInToken, isTrailing);
        private scanTriviaInfo(diagnostics, isTrailing);
        private isNewLineCharacter(ch);
        private scanWhitespaceTrivia(tokenText, tokenFullStart, firstTriviaStartInToken);
        private createTrivia(kind, tokenText, tokenFullStart, firstTriviaStartInToken, absoluteStartIndex);
        private scanSingleLineCommentTrivia(tokenText, tokenFullStart, firstTriviaStartInToken);
        private scanSingleLineCommentTriviaLength();
        private scanMultiLineCommentTrivia(tokenText, tokenFullStart, firstTriviaStartInToken);
        private scanMultiLineCommentTriviaLength(diagnostics);
        private scanLineTerminatorSequenceTrivia(tokenText, tokenFullStart, firstTriviaStartInToken, ch);
...
declare module TypeScript {
    interface ISeparatedSyntaxList<T extends ISyntaxNodeOrToken> extends ISyntaxElement {
...
declare module TypeScript.Syntax {
    function emptySeparatedList<T extends ISyntaxNodeOrToken>(): ISeparatedSyntaxList<T>;
    function separatedList<T extends ISyntaxNodeOrToken>(nodes: ISyntaxNodeOrToken[]): ISeparatedSyntaxList<T>;
    function nonSeparatorIndexOf<T extends ISyntaxNodeOrToken>(list: ISeparatedSyntaxList<T>, ast: ISyntaxNodeOrToken): number;
}
declare module TypeScript {
...
declare module TypeScript.Syntax {
    ...
    function setParentForChildren(element: ISyntaxElement): void;
    function emptySourceUnit(): SourceUnitSyntax;
    function getStandaloneExpression(positionedToken: ISyntaxToken): ISyntaxNodeOrToken;
    function isInModuleOrTypeContext(positionedToken: ISyntaxToken): boolean;
    function isInTypeOnlyContext(positionedToken: ISyntaxToken): boolean;
    ...
    function listStructuralEquals<T extends ISyntaxNodeOrToken>(list1: ISyntaxList<T>, list2: ISyntaxList<T>): boolean;
    function separatedListStructuralEquals<T extends ISyntaxNodeOrToken>(list1: ISeparatedSyntaxList<T>, list2: ISeparatedSyntaxList<T>): boolean;
    ...
    function nextToken(token: ISyntaxToken, includeSkippedTokens?: boolean): ISyntaxToken;
    function containingNode(element: ISyntaxElement): SyntaxNode;
    function findToken(element: ISyntaxElement, position: number): ISyntaxToken;
...
declare module TypeScript.Syntax {
    ...
    class NormalModeFactory implements IFactory {
        public sourceUnit(moduleElements: ISyntaxList<IModuleElementSyntax>, endOfFileToken: ISyntaxToken): SourceUnitSyntax;
        ...
        public importDeclaration(modifiers: ISyntaxList<ISyntaxToken>, importKeyword: ISyntaxToken, identifier: ISyntaxToken, equalsToken: ISyntaxToken, moduleReference: IModuleReferenceSyntax, semicolonToken: ISyntaxToken): ImportDeclarationSyntax;
        ...
        public classDeclaration(modifiers: ISyntaxList<ISyntaxToken>, classKeyword: ISyntaxToken, identifier: ISyntaxToken, typeParameterList: TypeParameterListSyntax, heritageClauses: ISyntaxList<HeritageClauseSyntax>, openBraceToken: ISyntaxToken, classElements: ISyntaxList<IClassElementSyntax>, closeBraceToken: ISyntaxToken): ClassDeclarationSyntax;
        public interfaceDeclaration(modifiers: ISyntaxList<ISyntaxToken>, interfaceKeyword: ISyntaxToken, identifier: ISyntaxToken, typeParameterList: TypeParameterListSyntax, heritageClauses: ISyntaxList<HeritageClauseSyntax>, body: ObjectTypeSyntax): InterfaceDeclarationSyntax;
        public heritageClause(kind: SyntaxKind, extendsOrImplementsKeyword: ISyntaxToken, typeNames: ISeparatedSyntaxList<INameSyntax>): HeritageClauseSyntax;
        public moduleDeclaration(modifiers: ISyntaxList<ISyntaxToken>, moduleKeyword: ISyntaxToken, name: INameSyntax, stringLiteral: ISyntaxToken, openBraceToken: ISyntaxToken, moduleElements: ISyntaxList<IModuleElementSyntax>, closeBraceToken: ISyntaxToken): ModuleDeclarationSyntax;
        public functionDeclaration(modifiers: ISyntaxList<ISyntaxToken>, functionKeyword: ISyntaxToken, identifier: ISyntaxToken, callSignature: CallSignatureSyntax, block: BlockSyntax, semicolonToken: ISyntaxToken): FunctionDeclarationSyntax;
        public variableStatement(modifiers: ISyntaxList<ISyntaxToken>, variableDeclaration: VariableDeclarationSyntax, semicolonToken: ISyntaxToken): VariableStatementSyntax;
        public variableDeclaration(varKeyword: ISyntaxToken, variableDeclarators: ISeparatedSyntaxList<VariableDeclaratorSyntax>): VariableDeclarationSyntax;
        ...
        public arrayLiteralExpression(openBracketToken: ISyntaxToken, expressions: ISeparatedSyntaxList<IExpressionSyntax>, closeBracketToken: ISyntaxToken): ArrayLiteralExpressionSyntax;
        ...
        public typeArgumentList(lessThanToken: ISyntaxToken, typeArguments: ISeparatedSyntaxList<ITypeSyntax>, greaterThanToken: ISyntaxToken): TypeArgumentListSyntax;
        ...
        public objectType(openBraceToken: ISyntaxToken, typeMembers: ISeparatedSyntaxList<ITypeMemberSyntax>, closeBraceToken: ISyntaxToken): ObjectTypeSyntax;
        ...
        public block(openBraceToken: ISyntaxToken, statements: ISyntaxList<IStatementSyntax>, closeBraceToken: ISyntaxToken): BlockSyntax;
        public parameter(dotDotDotToken: ISyntaxToken, modifiers: ISyntaxList<ISyntaxToken>, identifier: ISyntaxToken, questionToken: ISyntaxToken, typeAnnotation: TypeAnnotationSyntax, equalsValueClause: EqualsValueClauseSyntax): ParameterSyntax;
        public memberAccessExpression(expression: ILeftHandSideExpressionSyntax, dotToken: ISyntaxToken, name: ISyntaxToken): MemberAccessExpressionSyntax;
        public postfixUnaryExpression(kind: SyntaxKind, operand: ILeftHandSideExpressionSyntax, operatorToken: ISyntaxToken): PostfixUnaryExpressionSyntax;
        public elementAccessExpression(expression: ILeftHandSideExpressionSyntax, openBracketToken: ISyntaxToken, argumentExpression: IExpressionSyntax, closeBracketToken: ISyntaxToken): ElementAccessExpressionSyntax;
        public invocationExpression(expression: ILeftHandSideExpressionSyntax, argumentList: ArgumentListSyntax): InvocationExpressionSyntax;
        public argumentList(typeArgumentList: TypeArgumentListSyntax, openParenToken: ISyntaxToken, _arguments: ISeparatedSyntaxList<IExpressionSyntax>, closeParenToken: ISyntaxToken): ArgumentListSyntax;
        ...
        public parameterList(openParenToken: ISyntaxToken, parameters: ISeparatedSyntaxList<ParameterSyntax>, closeParenToken: ISyntaxToken): ParameterListSyntax;
        public typeParameterList(lessThanToken: ISyntaxToken, typeParameters: ISeparatedSyntaxList<TypeParameterSyntax>, greaterThanToken: ISyntaxToken): TypeParameterListSyntax;
        ...
        public constructorDeclaration(modifiers: ISyntaxList<ISyntaxToken>, constructorKeyword: ISyntaxToken, callSignature: CallSignatureSyntax, block: BlockSyntax, semicolonToken: ISyntaxToken): ConstructorDeclarationSyntax;
        public memberFunctionDeclaration(modifiers: ISyntaxList<ISyntaxToken>, propertyName: ISyntaxToken, callSignature: CallSignatureSyntax, block: BlockSyntax, semicolonToken: ISyntaxToken): MemberFunctionDeclarationSyntax;
        public getAccessor(modifiers: ISyntaxList<ISyntaxToken>, getKeyword: ISyntaxToken, propertyName: ISyntaxToken, parameterList: ParameterListSyntax, typeAnnotation: TypeAnnotationSyntax, block: BlockSyntax): GetAccessorSyntax;
        public setAccessor(modifiers: ISyntaxList<ISyntaxToken>, setKeyword: ISyntaxToken, propertyName: ISyntaxToken, parameterList: ParameterListSyntax, block: BlockSyntax): SetAccessorSyntax;
        public memberVariableDeclaration(modifiers: ISyntaxList<ISyntaxToken>, variableDeclarator: VariableDeclaratorSyntax, semicolonToken: ISyntaxToken): MemberVariableDeclarationSyntax;
        public indexMemberDeclaration(modifiers: ISyntaxList<ISyntaxToken>, indexSignature: IndexSignatureSyntax, semicolonToken: ISyntaxToken): IndexMemberDeclarationSyntax;
        ...
        public switchStatement(switchKeyword: ISyntaxToken, openParenToken: ISyntaxToken, expression: IExpressionSyntax, closeParenToken: ISyntaxToken, openBraceToken: ISyntaxToken, switchClauses: ISyntaxList<ISwitchClauseSyntax>, closeBraceToken: ISyntaxToken): SwitchStatementSyntax;
        public caseSwitchClause(caseKeyword: ISyntaxToken, expression: IExpressionSyntax, colonToken: ISyntaxToken, statements: ISyntaxList<IStatementSyntax>): CaseSwitchClauseSyntax;
        public defaultSwitchClause(defaultKeyword: ISyntaxToken, colonToken: ISyntaxToken, statements: ISyntaxList<IStatementSyntax>): DefaultSwitchClauseSyntax;
        ...
        public enumDeclaration(modifiers: ISyntaxList<ISyntaxToken>, enumKeyword: ISyntaxToken, identifier: ISyntaxToken, openBraceToken: ISyntaxToken, enumElements: ISeparatedSyntaxList<EnumElementSyntax>, closeBraceToken: ISyntaxToken): EnumDeclarationSyntax;
        ...
        public objectLiteralExpression(openBraceToken: ISyntaxToken, propertyAssignments: ISeparatedSyntaxList<IPropertyAssignmentSyntax>, closeBraceToken: ISyntaxToken): ObjectLiteralExpressionSyntax;
...
declare module TypeScript {
    interface ISyntaxList<T extends ISyntaxNodeOrToken> extends ISyntaxElement {
...
declare module TypeScript.Syntax {
    class EmptySyntaxList<T extends ISyntaxNodeOrToken> implements ISyntaxList<T> {
    ...
    function emptyList<T extends ISyntaxNodeOrToken>(): ISyntaxList<T>;
    function list<T extends ISyntaxNodeOrToken>(nodes: T[]): ISyntaxList<T>;
}
declare module TypeScript {
    class SyntaxNode implements ISyntaxNodeOrToken {
        ...
        */
        public findToken(position: number, includeSkippedTokens?: boolean): ISyntaxToken;
        private tryGetEndOfFileAt(position);
        public findTokenOnLeft(position: number, includeSkippedTokens?: boolean): ISyntaxToken;
        public findCompleteTokenOnLeft(position: number, includeSkippedTokens?: boolean): ISyntaxToken;
...
declare module TypeScript {
    class SourceUnitSyntax extends SyntaxNode {
        ...
        constructor(moduleElements: ISyntaxList<IModuleElementSyntax>, endOfFileToken: ISyntaxToken, parsedInStrictMode: boolean);
        public accept(visitor: ISyntaxVisitor): any;
        public kind(): SyntaxKind;
        public childCount(): number;
        public childAt(slot: number): ISyntaxElement;
        public syntaxTree(): SyntaxTree;
        public update(moduleElements: ISyntaxList<IModuleElementSyntax>, endOfFileToken: ISyntaxToken): SourceUnitSyntax;
    ...
    class ImportDeclarationSyntax extends SyntaxNode implements IModuleElementSyntax {
        ...
        constructor(modifiers: ISyntaxList<ISyntaxToken>, importKeyword: ISyntaxToken, identifier: ISyntaxToken, equalsToken: ISyntaxToken, moduleReference: IModuleReferenceSyntax, semicolonToken: ISyntaxToken, parsedInStrictMode: boolean);
        public accept(visitor: ISyntaxVisitor): any;
        public kind(): SyntaxKind;
        public childCount(): number;
        public childAt(slot: number): ISyntaxElement;
        public isModuleElement(): boolean;
        public update(modifiers: ISyntaxList<ISyntaxToken>, importKeyword: ISyntaxToken, identifier: ISyntaxToken, equalsToken: ISyntaxToken, moduleReference: IModuleReferenceSyntax, semicolonToken: ISyntaxToken): ImportDeclarationSyntax;
    ...
    class ClassDeclarationSyntax extends SyntaxNode implements IModuleElementSyntax {
        ...
        constructor(modifiers: ISyntaxList<ISyntaxToken>, classKeyword: ISyntaxToken, identifier: ISyntaxToken, typeParameterList: TypeParameterListSyntax, heritageClauses: ISyntaxList<HeritageClauseSyntax>, openBraceToken: ISyntaxToken, classElements: ISyntaxList<IClassElementSyntax>, closeBraceToken: ISyntaxToken, parsedInStrictMode: boolean);
        public accept(visitor: ISyntaxVisitor): any;
        public kind(): SyntaxKind;
        public childCount(): number;
        public childAt(slot: number): ISyntaxElement;
        public isModuleElement(): boolean;
        public update(modifiers: ISyntaxList<ISyntaxToken>, classKeyword: ISyntaxToken, identifier: ISyntaxToken, typeParameterList: TypeParameterListSyntax, heritageClauses: ISyntaxList<HeritageClauseSyntax>, openBraceToken: ISyntaxToken, classElements: ISyntaxList<IClassElementSyntax>, closeBraceToken: ISyntaxToken): ClassDeclarationSyntax;
    ...
    class InterfaceDeclarationSyntax extends SyntaxNode implements IModuleElementSyntax {
        ...
        constructor(modifiers: ISyntaxList<ISyntaxToken>, interfaceKeyword: ISyntaxToken, identifier: ISyntaxToken, typeParameterList: TypeParameterListSyntax, heritageClauses: ISyntaxList<HeritageClauseSyntax>, body: ObjectTypeSyntax, parsedInStrictMode: boolean);
        public accept(visitor: ISyntaxVisitor): any;
        public kind(): SyntaxKind;
        public childCount(): number;
        public childAt(slot: number): ISyntaxElement;
        public isModuleElement(): boolean;
        public update(modifiers: ISyntaxList<ISyntaxToken>, interfaceKeyword: ISyntaxToken, identifier: ISyntaxToken, typeParameterList: TypeParameterListSyntax, heritageClauses: ISyntaxList<HeritageClauseSyntax>, body: ObjectTypeSyntax): InterfaceDeclarationSyntax;
    ...
    class HeritageClauseSyntax extends SyntaxNode {
        ...
        private _kind;
        constructor(kind: SyntaxKind, extendsOrImplementsKeyword: ISyntaxToken, typeNames: ISeparatedSyntaxList<INameSyntax>, parsedInStrictMode: boolean);
        public accept(visitor: ISyntaxVisitor): any;
        public childCount(): number;
        public childAt(slot: number): ISyntaxElement;
        public kind(): SyntaxKind;
        public update(kind: SyntaxKind, extendsOrImplementsKeyword: ISyntaxToken, typeNames: ISeparatedSyntaxList<INameSyntax>): HeritageClauseSyntax;
    ...
    class ModuleDeclarationSyntax extends SyntaxNode implements IModuleElementSyntax {
        ...
        public moduleElements: ISyntaxList<IModuleElementSyntax>;
        public closeBraceToken: ISyntaxToken;
        constructor(modifiers: ISyntaxList<ISyntaxToken>, moduleKeyword: ISyntaxToken, name: INameSyntax, stringLiteral: ISyntaxToken, openBraceToken: ISyntaxToken, moduleElements: ISyntaxList<IModuleElementSyntax>, closeBraceToken: ISyntaxToken, parsedInStrictMode: boolean);
        public accept(visitor: ISyntaxVisitor): any;
        public kind(): SyntaxKind;
        public childCount(): number;
        public childAt(slot: number): ISyntaxElement;
        public isModuleElement(): boolean;
        public update(modifiers: ISyntaxList<ISyntaxToken>, moduleKeyword: ISyntaxToken, name: INameSyntax, stringLiteral: ISyntaxToken, openBraceToken: ISyntaxToken, moduleElements: ISyntaxList<IModuleElementSyntax>, closeBraceToken: ISyntaxToken): ModuleDeclarationSyntax;
    ...
    class FunctionDeclarationSyntax extends SyntaxNode implements IStatementSyntax {
        ...
        public semicolonToken: ISyntaxToken;
        constructor(modifiers: ISyntaxList<ISyntaxToken>, functionKeyword: ISyntaxToken, identifier: ISyntaxToken, callSignature: CallSignatureSyntax, block: BlockSyntax, semicolonToken: ISyntaxToken, parsedInStrictMode: boolean);
        public accept(visitor: ISyntaxVisitor): any;
        public kind(): SyntaxKind;
        public childCount(): number;
        public childAt(slot: number): ISyntaxElement;
        public isStatement(): boolean;
        public isModuleElement(): boolean;
        public update(modifiers: ISyntaxList<ISyntaxToken>, functionKeyword: ISyntaxToken, identifier: ISyntaxToken, callSignature: CallSignatureSyntax, block: BlockSyntax, semicolonToken: ISyntaxToken): FunctionDeclarationSyntax;
    ...
    class VariableStatementSyntax extends SyntaxNode implements IStatementSyntax {
        ...
        public semicolonToken: ISyntaxToken;
        constructor(modifiers: ISyntaxList<ISyntaxToken>, variableDeclaration: VariableDeclarationSyntax, semicolonToken: ISyntaxToken, parsedInStrictMode: boolean);
        public accept(visitor: ISyntaxVisitor): any;
        public kind(): SyntaxKind;
        public childCount(): number;
        public childAt(slot: number): ISyntaxElement;
        public isStatement(): boolean;
        public isModuleElement(): boolean;
        public update(modifiers: ISyntaxList<ISyntaxToken>, variableDeclaration: VariableDeclarationSyntax, semicolonToken: ISyntaxToken): VariableStatementSyntax;
    ...
    class VariableDeclarationSyntax extends SyntaxNode {
        ...
        constructor(varKeyword: ISyntaxToken, variableDeclarators: ISeparatedSyntaxList<VariableDeclaratorSyntax>, parsedInStrictMode: boolean);
        public accept(visitor: ISyntaxVisitor): any;
        public kind(): SyntaxKind;
        public childCount(): number;
        public childAt(slot: number): ISyntaxElement;
        public update(varKeyword: ISyntaxToken, variableDeclarators: ISeparatedSyntaxList<VariableDeclaratorSyntax>): VariableDeclarationSyntax;
        static create1(variableDeclarators: ISeparatedSyntaxList<VariableDeclaratorSyntax>): VariableDeclarationSyntax;
    ...
    class ArrayLiteralExpressionSyntax extends SyntaxNode implements IPrimaryExpressionSyntax {
        ...
        constructor(openBracketToken: ISyntaxToken, expressions: ISeparatedSyntaxList<IExpressionSyntax>, closeBracketToken: ISyntaxToken, parsedInStrictMode: boolean);
        public accept(visitor: ISyntaxVisitor): any;
        public kind(): SyntaxKind;
        public childCount(): number;
        public childAt(slot: number): ISyntaxElement;
        ...
        public isUnaryExpression(): boolean;
        public isExpression(): boolean;
        public update(openBracketToken: ISyntaxToken, expressions: ISeparatedSyntaxList<IExpressionSyntax>, closeBracketToken: ISyntaxToken): ArrayLiteralExpressionSyntax;
    ...
    class TypeArgumentListSyntax extends SyntaxNode {
        ...
        constructor(lessThanToken: ISyntaxToken, typeArguments: ISeparatedSyntaxList<ITypeSyntax>, greaterThanToken: ISyntaxToken, parsedInStrictMode: boolean);
        public accept(visitor: ISyntaxVisitor): any;
        public kind(): SyntaxKind;
        public childCount(): number;
        public childAt(slot: number): ISyntaxElement;
        public update(lessThanToken: ISyntaxToken, typeArguments: ISeparatedSyntaxList<ITypeSyntax>, greaterThanToken: ISyntaxToken): TypeArgumentListSyntax;
    ...
    class ObjectTypeSyntax extends SyntaxNode implements ITypeSyntax {
        ...
        public closeBraceToken: ISyntaxToken;
        constructor(openBraceToken: ISyntaxToken, typeMembers: ISeparatedSyntaxList<ITypeMemberSyntax>, closeBraceToken: ISyntaxToken, parsedInStrictMode: boolean);
        public accept(visitor: ISyntaxVisitor): any;
        public kind(): SyntaxKind;
        public childCount(): number;
        public childAt(slot: number): ISyntaxElement;
        public isType(): boolean;
        public update(openBraceToken: ISyntaxToken, typeMembers: ISeparatedSyntaxList<ITypeMemberSyntax>, closeBraceToken: ISyntaxToken): ObjectTypeSyntax;
    ...
    class BlockSyntax extends SyntaxNode implements IStatementSyntax {
        ...
        public closeBraceToken: ISyntaxToken;
        constructor(openBraceToken: ISyntaxToken, statements: ISyntaxList<IStatementSyntax>, closeBraceToken: ISyntaxToken, parsedInStrictMode: boolean);
        public accept(visitor: ISyntaxVisitor): any;
        public kind(): SyntaxKind;
        public childCount(): number;
        public childAt(slot: number): ISyntaxElement;
        public isStatement(): boolean;
        public isModuleElement(): boolean;
        public update(openBraceToken: ISyntaxToken, statements: ISyntaxList<IStatementSyntax>, closeBraceToken: ISyntaxToken): BlockSyntax;
    ...
    class ParameterSyntax extends SyntaxNode {
        ...
        public typeAnnotation: TypeAnnotationSyntax;
        public equalsValueClause: EqualsValueClauseSyntax;
        constructor(dotDotDotToken: ISyntaxToken, modifiers: ISyntaxList<ISyntaxToken>, identifier: ISyntaxToken, questionToken: ISyntaxToken, typeAnnotation: TypeAnnotationSyntax, equalsValueClause: EqualsValueClauseSyntax, parsedInStrictMode: boolean);
        public accept(visitor: ISyntaxVisitor): any;
        public kind(): SyntaxKind;
        public childCount(): number;
        public childAt(slot: number): ISyntaxElement;
        public update(dotDotDotToken: ISyntaxToken, modifiers: ISyntaxList<ISyntaxToken>, identifier: ISyntaxToken, questionToken: ISyntaxToken, typeAnnotation: TypeAnnotationSyntax, equalsValueClause: EqualsValueClauseSyntax): ParameterSyntax;
    ...
    class MemberAccessExpressionSyntax extends SyntaxNode implements IMemberExpressionSyntax, ICallExpressionSyntax {
        ...
        constructor(expression: ILeftHandSideExpressionSyntax, dotToken: ISyntaxToken, name: ISyntaxToken, parsedInStrictMode: boolean);
        public accept(visitor: ISyntaxVisitor): any;
        public kind(): SyntaxKind;
        public childCount(): number;
        public childAt(slot: number): ISyntaxElement;
        ...
        public isUnaryExpression(): boolean;
        public isExpression(): boolean;
        public update(expression: ILeftHandSideExpressionSyntax, dotToken: ISyntaxToken, name: ISyntaxToken): MemberAccessExpressionSyntax;
        static create1(expression: ILeftHandSideExpressionSyntax, name: ISyntaxToken): MemberAccessExpressionSyntax;
    ...
    class PostfixUnaryExpressionSyntax extends SyntaxNode implements IPostfixExpressionSyntax {
        ...
        public operatorToken: ISyntaxToken;
        private _kind;
        constructor(kind: SyntaxKind, operand: ILeftHandSideExpressionSyntax, operatorToken: ISyntaxToken, parsedInStrictMode: boolean);
        public accept(visitor: ISyntaxVisitor): any;
        public childCount(): number;
        public childAt(slot: number): ISyntaxElement;
        public isPostfixExpression(): boolean;
        ...
        public isExpression(): boolean;
        public kind(): SyntaxKind;
        public update(kind: SyntaxKind, operand: ILeftHandSideExpressionSyntax, operatorToken: ISyntaxToken): PostfixUnaryExpressionSyntax;
    ...
    class ElementAccessExpressionSyntax extends SyntaxNode implements IMemberExpressionSyntax, ICallExpressionSyntax {
        ...
        public closeBracketToken: ISyntaxToken;
        constructor(expression: ILeftHandSideExpressionSyntax, openBracketToken: ISyntaxToken, argumentExpression: IExpressionSyntax, closeBracketToken: ISyntaxToken, parsedInStrictMode: boolean);
        public accept(visitor: ISyntaxVisitor): any;
        public kind(): SyntaxKind;
        public childCount(): number;
        public childAt(slot: number): ISyntaxElement;
        ...
        public isUnaryExpression(): boolean;
        public isExpression(): boolean;
        public update(expression: ILeftHandSideExpressionSyntax, openBracketToken: ISyntaxToken, argumentExpression: IExpressionSyntax, closeBracketToken: ISyntaxToken): ElementAccessExpressionSyntax;
        static create1(expression: ILeftHandSideExpressionSyntax, argumentExpression: IExpressionSyntax): ElementAccessExpressionSyntax;
    ...
    class InvocationExpressionSyntax extends SyntaxNode implements ICallExpressionSyntax, IExpressionWithArgumentListSyntax {
        public expression: ILeftHandSideExpressionSyntax;
        public argumentList: ArgumentListSyntax;
        constructor(expression: ILeftHandSideExpressionSyntax, argumentList: ArgumentListSyntax, parsedInStrictMode: boolean);
        public accept(visitor: ISyntaxVisitor): any;
        public kind(): SyntaxKind;
        public childCount(): number;
        public childAt(slot: number): ISyntaxElement;
        ...
        public isUnaryExpression(): boolean;
        public isExpression(): boolean;
        public update(expression: ILeftHandSideExpressionSyntax, argumentList: ArgumentListSyntax): InvocationExpressionSyntax;
        static create1(expression: ILeftHandSideExpressionSyntax): InvocationExpressionSyntax;
    ...
    class ArgumentListSyntax extends SyntaxNode {
        ...
        constructor(typeArgumentList: TypeArgumentListSyntax, openParenToken: ISyntaxToken, _arguments: ISeparatedSyntaxList<IExpressionSyntax>, closeParenToken: ISyntaxToken, parsedInStrictMode: boolean);
        public accept(visitor: ISyntaxVisitor): any;
        public kind(): SyntaxKind;
        public childCount(): number;
        public childAt(slot: number): ISyntaxElement;
        public update(typeArgumentList: TypeArgumentListSyntax, openParenToken: ISyntaxToken, _arguments: ISeparatedSyntaxList<IExpressionSyntax>, closeParenToken: ISyntaxToken): ArgumentListSyntax;
    ...
    class ParameterListSyntax extends SyntaxNode {
        ...
        public closeParenToken: ISyntaxToken;
        constructor(openParenToken: ISyntaxToken, parameters: ISeparatedSyntaxList<ParameterSyntax>, closeParenToken: ISyntaxToken, parsedInStrictMode: boolean);
        public accept(visitor: ISyntaxVisitor): any;
        public kind(): SyntaxKind;
        public childCount(): number;
        public childAt(slot: number): ISyntaxElement;
        public update(openParenToken: ISyntaxToken, parameters: ISeparatedSyntaxList<ParameterSyntax>, closeParenToken: ISyntaxToken): ParameterListSyntax;
    ...
    class TypeParameterListSyntax extends SyntaxNode {
        ...
        public greaterThanToken: ISyntaxToken;
        constructor(lessThanToken: ISyntaxToken, typeParameters: ISeparatedSyntaxList<TypeParameterSyntax>, greaterThanToken: ISyntaxToken, parsedInStrictMode: boolean);
        public accept(visitor: ISyntaxVisitor): any;
        public kind(): SyntaxKind;
        public childCount(): number;
        public childAt(slot: number): ISyntaxElement;
        public update(lessThanToken: ISyntaxToken, typeParameters: ISeparatedSyntaxList<TypeParameterSyntax>, greaterThanToken: ISyntaxToken): TypeParameterListSyntax;
    ...
    class ConstructorDeclarationSyntax extends SyntaxNode implements IClassElementSyntax {
        ...
        public block: BlockSyntax;
        public semicolonToken: ISyntaxToken;
        constructor(modifiers: ISyntaxList<ISyntaxToken>, constructorKeyword: ISyntaxToken, callSignature: CallSignatureSyntax, block: BlockSyntax, semicolonToken: ISyntaxToken, parsedInStrictMode: boolean);
        public accept(visitor: ISyntaxVisitor): any;
        public kind(): SyntaxKind;
        public childCount(): number;
        public childAt(slot: number): ISyntaxElement;
        public isClassElement(): boolean;
        public update(modifiers: ISyntaxList<ISyntaxToken>, constructorKeyword: ISyntaxToken, callSignature: CallSignatureSyntax, block: BlockSyntax, semicolonToken: ISyntaxToken): ConstructorDeclarationSyntax;
    ...
    class MemberFunctionDeclarationSyntax extends SyntaxNode implements IMemberDeclarationSyntax {
        ...
        public block: BlockSyntax;
        public semicolonToken: ISyntaxToken;
        constructor(modifiers: ISyntaxList<ISyntaxToken>, propertyName: ISyntaxToken, callSignature: CallSignatureSyntax, block: BlockSyntax, semicolonToken: ISyntaxToken, parsedInStrictMode: boolean);
        public accept(visitor: ISyntaxVisitor): any;
        public kind(): SyntaxKind;
        public childCount(): number;
        public childAt(slot: number): ISyntaxElement;
        ...
        public isClassElement(): boolean;
        public update(modifiers: ISyntaxList<ISyntaxToken>, propertyName: ISyntaxToken, callSignature: CallSignatureSyntax, block: BlockSyntax, semicolonToken: ISyntaxToken): MemberFunctionDeclarationSyntax;
    ...
    class GetAccessorSyntax extends SyntaxNode implements IMemberDeclarationSyntax, IPropertyAssignmentSyntax {
        ...
        public typeAnnotation: TypeAnnotationSyntax;
        public block: BlockSyntax;
        constructor(modifiers: ISyntaxList<ISyntaxToken>, getKeyword: ISyntaxToken, propertyName: ISyntaxToken, parameterList: ParameterListSyntax, typeAnnotation: TypeAnnotationSyntax, block: BlockSyntax, parsedInStrictMode: boolean);
        public accept(visitor: ISyntaxVisitor): any;
        public kind(): SyntaxKind;
        public childCount(): number;
        public childAt(slot: number): ISyntaxElement;
        ...
        public isClassElement(): boolean;
        public update(modifiers: ISyntaxList<ISyntaxToken>, getKeyword: ISyntaxToken, propertyName: ISyntaxToken, parameterList: ParameterListSyntax, typeAnnotation: TypeAnnotationSyntax, block: BlockSyntax): GetAccessorSyntax;
    ...
    class SetAccessorSyntax extends SyntaxNode implements IMemberDeclarationSyntax, IPropertyAssignmentSyntax {
        ...
        public parameterList: ParameterListSyntax;
        public block: BlockSyntax;
        constructor(modifiers: ISyntaxList<ISyntaxToken>, setKeyword: ISyntaxToken, propertyName: ISyntaxToken, parameterList: ParameterListSyntax, block: BlockSyntax, parsedInStrictMode: boolean);
        public accept(visitor: ISyntaxVisitor): any;
        public kind(): SyntaxKind;
        public childCount(): number;
        public childAt(slot: number): ISyntaxElement;
        ...
        public isPropertyAssignment(): boolean;
        public isClassElement(): boolean;
        public update(modifiers: ISyntaxList<ISyntaxToken>, setKeyword: ISyntaxToken, propertyName: ISyntaxToken, parameterList: ParameterListSyntax, block: BlockSyntax): SetAccessorSyntax;
    ...
    class MemberVariableDeclarationSyntax extends SyntaxNode implements IMemberDeclarationSyntax {
        ...
        public semicolonToken: ISyntaxToken;
        constructor(modifiers: ISyntaxList<ISyntaxToken>, variableDeclarator: VariableDeclaratorSyntax, semicolonToken: ISyntaxToken, parsedInStrictMode: boolean);
        public accept(visitor: ISyntaxVisitor): any;
        public kind(): SyntaxKind;
        public childCount(): number;
        public childAt(slot: number): ISyntaxElement;
        public isMemberDeclaration(): boolean;
        public isClassElement(): boolean;
        public update(modifiers: ISyntaxList<ISyntaxToken>, variableDeclarator: VariableDeclaratorSyntax, semicolonToken: ISyntaxToken): MemberVariableDeclarationSyntax;
    ...
    class IndexMemberDeclarationSyntax extends SyntaxNode implements IClassElementSyntax {
        ...
        public semicolonToken: ISyntaxToken;
        constructor(modifiers: ISyntaxList<ISyntaxToken>, indexSignature: IndexSignatureSyntax, semicolonToken: ISyntaxToken, parsedInStrictMode: boolean);
        public accept(visitor: ISyntaxVisitor): any;
        public kind(): SyntaxKind;
        public childCount(): number;
        public childAt(slot: number): ISyntaxElement;
        public isClassElement(): boolean;
        public update(modifiers: ISyntaxList<ISyntaxToken>, indexSignature: IndexSignatureSyntax, semicolonToken: ISyntaxToken): IndexMemberDeclarationSyntax;
    ...
    class ObjectCreationExpressionSyntax extends SyntaxNode implements IMemberExpressionSyntax, IExpressionWithArgumentListSyntax {
        public newKeyword: ISyntaxToken;
    ...
    class SwitchStatementSyntax extends SyntaxNode implements IStatementSyntax {
        ...
        public closeBraceToken: ISyntaxToken;
        constructor(switchKeyword: ISyntaxToken, openParenToken: ISyntaxToken, expression: IExpressionSyntax, closeParenToken: ISyntaxToken, openBraceToken: ISyntaxToken, switchClauses: ISyntaxList<ISwitchClauseSyntax>, closeBraceToken: ISyntaxToken, parsedInStrictMode: boolean);
        public accept(visitor: ISyntaxVisitor): any;
        public kind(): SyntaxKind;
        public childCount(): number;
        public childAt(slot: number): ISyntaxElement;
        public isStatement(): boolean;
        public isModuleElement(): boolean;
        public update(switchKeyword: ISyntaxToken, openParenToken: ISyntaxToken, expression: IExpressionSyntax, closeParenToken: ISyntaxToken, openBraceToken: ISyntaxToken, switchClauses: ISyntaxList<ISwitchClauseSyntax>, closeBraceToken: ISyntaxToken): SwitchStatementSyntax;
    ...
    class CaseSwitchClauseSyntax extends SyntaxNode implements ISwitchClauseSyntax {
        ...
        public colonToken: ISyntaxToken;
        public statements: ISyntaxList<IStatementSyntax>;
        constructor(caseKeyword: ISyntaxToken, expression: IExpressionSyntax, colonToken: ISyntaxToken, statements: ISyntaxList<IStatementSyntax>, parsedInStrictMode: boolean);
        public accept(visitor: ISyntaxVisitor): any;
        public kind(): SyntaxKind;
        public childCount(): number;
        public childAt(slot: number): ISyntaxElement;
        public isSwitchClause(): boolean;
        public update(caseKeyword: ISyntaxToken, expression: IExpressionSyntax, colonToken: ISyntaxToken, statements: ISyntaxList<IStatementSyntax>): CaseSwitchClauseSyntax;
    ...
    class DefaultSwitchClauseSyntax extends SyntaxNode implements ISwitchClauseSyntax {
        ...
        public colonToken: ISyntaxToken;
        public statements: ISyntaxList<IStatementSyntax>;
        constructor(defaultKeyword: ISyntaxToken, colonToken: ISyntaxToken, statements: ISyntaxList<IStatementSyntax>, parsedInStrictMode: boolean);
        public accept(visitor: ISyntaxVisitor): any;
        public kind(): SyntaxKind;
        public childCount(): number;
        public childAt(slot: number): ISyntaxElement;
        public isSwitchClause(): boolean;
        public update(defaultKeyword: ISyntaxToken, colonToken: ISyntaxToken, statements: ISyntaxList<IStatementSyntax>): DefaultSwitchClauseSyntax;
    ...
    class EnumDeclarationSyntax extends SyntaxNode implements IModuleElementSyntax {
        ...
        public closeBraceToken: ISyntaxToken;
        constructor(modifiers: ISyntaxList<ISyntaxToken>, enumKeyword: ISyntaxToken, identifier: ISyntaxToken, openBraceToken: ISyntaxToken, enumElements: ISeparatedSyntaxList<EnumElementSyntax>, closeBraceToken: ISyntaxToken, parsedInStrictMode: boolean);
        public accept(visitor: ISyntaxVisitor): any;
        public kind(): SyntaxKind;
        public childCount(): number;
        public childAt(slot: number): ISyntaxElement;
        public isModuleElement(): boolean;
        public update(modifiers: ISyntaxList<ISyntaxToken>, enumKeyword: ISyntaxToken, identifier: ISyntaxToken, openBraceToken: ISyntaxToken, enumElements: ISeparatedSyntaxList<EnumElementSyntax>, closeBraceToken: ISyntaxToken): EnumDeclarationSyntax;
    ...
    class ObjectLiteralExpressionSyntax extends SyntaxNode implements IPrimaryExpressionSyntax {
        ...
        public closeBraceToken: ISyntaxToken;
        constructor(openBraceToken: ISyntaxToken, propertyAssignments: ISeparatedSyntaxList<IPropertyAssignmentSyntax>, closeBraceToken: ISyntaxToken, parsedInStrictMode: boolean);
        public accept(visitor: ISyntaxVisitor): any;
        public kind(): SyntaxKind;
        public childCount(): number;
        public childAt(slot: number): ISyntaxElement;
        ...
        public isUnaryExpression(): boolean;
        public isExpression(): boolean;
        public update(openBraceToken: ISyntaxToken, propertyAssignments: ISeparatedSyntaxList<IPropertyAssignmentSyntax>, closeBraceToken: ISyntaxToken): ObjectLiteralExpressionSyntax;
...
declare module TypeScript {
    class SyntaxDedenter extends SyntaxRewriter {
        ...
        static dedentNode<T extends ISyntaxNode>(node: T, dedentFirstToken: boolean, dedentAmount: number, minimumIndent: number, options: FormattingOptions): T;
    }
}
declare module TypeScript {
...
declare module TypeScript.Syntax {
    class VariableWidthTokenWithNoTrivia implements ISyntaxToken {
        ...
        public accept(visitor: ISyntaxVisitor): any;
        private realize();
        public previousToken(includeSkippedTokens?: boolean): ISyntaxToken;
        public nextToken(includeSkippedTokens?: boolean): ISyntaxToken;
        public collectTextElements(elements: string[]): void;
...
declare module TypeScript.Syntax {
    function isPrimaryExpression(token: ISyntaxToken): boolean;
    ...
    function token(kind: SyntaxKind, info?: ITokenInfo, fullStart?: number): ISyntaxToken;
...
declare module TypeScript.Syntax {
    function deferredTrivia(kind: SyntaxKind, fullStart: number, tokenText: string, startInTokenText: number, fullWidth: number): ISyntaxTrivia;
    function trivia(kind: SyntaxKind, text: string, fullStart: number): ISyntaxTrivia;
...
declare module TypeScript {
    class SyntaxUtilities {
        ...
        static getToken(list: ISyntaxList<ISyntaxToken>, kind: SyntaxKind): ISyntaxToken;
        static containsToken(list: ISyntaxList<ISyntaxToken>, kind: SyntaxKind): boolean;
        ...
        static isAmbientDeclarationSyntax(positionNode: SyntaxNode): boolean;
    }
}
declare module TypeScript {
...
declare module TypeScript.ASTHelpers {
    ...
    function getExtendsHeritageClause(clauses: ISyntaxList<HeritageClauseSyntax>): HeritageClauseSyntax;
    function getImplementsHeritageClause(clauses: ISyntaxList<HeritageClauseSyntax>): HeritageClauseSyntax;
    ...
    function getEnclosingMemberVariableDeclaration(ast: ISyntaxElement): MemberVariableDeclarationSyntax;
    ...
    function parametersFromIdentifier(id: ISyntaxToken): IParameters;
    function parametersFromParameter(parameter: ParameterSyntax): IParameters;
    function parametersFromParameterList(list: ParameterListSyntax): IParameters;
    function isDeclarationAST(ast: ISyntaxElement): boolean;
    function preComments(element: ISyntaxElement): Comment[];
    function postComments(element: ISyntaxElement): Comment[];
    function convertTokenLeadingComments(token: ISyntaxToken): Comment[];
    function convertTokenTrailingComments(token: ISyntaxToken): Comment[];
    function docComments(ast: ISyntaxElement): Comment[];
    function isDocComment(comment: Comment): boolean;
    function getParameterList(ast: ISyntaxElement): ParameterListSyntax;
    function getType(ast: ISyntaxElement): ISyntaxNodeOrToken;
    function getVariableDeclaratorModifiers(variableDeclarator: VariableDeclaratorSyntax): ISyntaxList<ISyntaxToken>;
...
declare module TypeScript {
    ...
    class SourceMapper {
        ...
        public decreaseMappingLevel(ast: ISpan): void;
...
declare module TypeScript {
    ...
    function lastParameterIsRest(parameterList: ParameterListSyntax): boolean;
    class Emitter {
        ...
        private recordSourceMappingSpanStart(ast);
        private recordSourceMappingEnd(ast);
        private recordSourceMappingSpanEnd(ast);
        ...
        public emitList<T extends ISyntaxNodeOrToken>(list: ISyntaxList<T>, useNewLineSeparator?: boolean, startInclusive?: number, endExclusive?: number): void;
        public emitSeparatedList<T extends ISyntaxNodeOrToken>(list: ISeparatedSyntaxList<T>, useNewLineSeparator?: boolean, startInclusive?: number, endExclusive?: number): void;
...
declare module TypeScript {
    ...
    function hasModifier(modifiers: ISyntaxList<ISyntaxToken>, flag: PullElementFlags): boolean;
...
declare module TypeScript {
    ...
    class PullTypeResolver {
        ...
        static isInStaticMemberContext(decl: PullDecl): boolean;
...
declare module TypeScript {
    ...
    class SemanticInfoChain {
        ...
        public addDiagnosticFromAST(ast: ISyntaxElement, diagnosticKey: string, _arguments?: any[], additionalLocations?: Location[]): void;
        public diagnosticFromAST(ast: ISyntaxElement, diagnosticKey: string, _arguments?: any[], additionalLocations?: Location[]): Diagnostic;
