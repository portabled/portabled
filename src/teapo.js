...
var teapo;
(function (teapo) {
    /** Making standard 3-piece application layout: content, left, right panels, toolbar, status bar. */
    var ApplicationLayout = (function () {
        function ApplicationLayout(_host) {
            ...
            this._splitter = new teapo.SplitHost(this._contentArea);

            teapo.cleanContent(this._host);
...
var teapo;
(function (teapo) {
    /** Bootstrapping with ApplicationLayout. */
